...
-- Listage des données de la table forum_elenajaeg.user : ~8 rows (environ)
REPLACE INTO `user` (`id_user`, `username`, `email`, `password`, `registerDate`, `role`, `avatar`, `status`) VALUES
	...
	(4, 'admin', 'admin@exemple.com', '$2y$10$.7a4y2pQPP0j4dH01ZU4j.agUdZAimMV.X7lgdpQBE7M1W8ULQPMC', '2024-04-03 13:39:40', 'role_admin', 'admin.jpg', 0),
	...
	(10, 'tania', 'tania@sfr.fr', '$2y$10$4TGwrft26RusbI0gBW8bCuToO79A2dW0iePAqouoH0ysCgYGUp/em', '2024-05-21 09:15:17', 'role_user', 'User-avatar.png', 0);
